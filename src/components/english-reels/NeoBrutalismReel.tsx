  ...
  return (
    ...
    >
      ...
      {/* =========================================================================
          ...
          ========================================================================= */}
      {frame >= 660 && frame < 960 && (
        <Scene3BrutalistNegAndQ frame={frame - 660} fps={fps} />
      )}
      ...
      {frame >= 960 && frame < 1380 && (
        <Scene4BrutalistHabits frame={frame - 960} fps={fps} />
      )}
      ...
      {frame >= 1380 && frame < 1560 && (
        <Scene5BrutalistFacts frame={frame - 1380} fps={fps} />
      )}
      ...
      {frame >= 1560 && frame < 1770 && (
        <Scene6BrutalistInstructions frame={frame - 1560} fps={fps} />
      )}
      ...
      {frame >= 1770 && frame < 1950 && (
        <Scene7BrutalistStories frame={frame - 1770} fps={fps} />
      )}
      ...
      {/* =========================================================================
          ...
          ========================================================================= */}
      {frame >= 1950 && (
        <Scene8BrutalistCTA frame={frame - 1950} fps={fps} />
      )}
